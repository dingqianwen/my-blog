!function(e, t) {
    ...
    var e = navigator.userAgent
        ...
        , K = /Mac OS X 1\d\D([8-9]|\d\d)\D/.test(e)
        , j = /PhantomJS/.test(e)
        , X = V && (/Mobile\/\w+/.test(e) || 2 < navigator.maxTouchPoints)
        , Y = /Android/.test(e)
        , $ = X || Y || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(e)
        , C = X || /Mac/.test(l)
        , _ = /\bCrOS\b/.test(e)
        , a = /win/i.test(l)
        , u = m && e.match(/Version\/(\d*\.\d*)/)
        , q = ((u = u && Number(u[1])) && 15 <= u && (x = !(m = !1)),
    C && (s || m && (null == u || u < 12.11)))
        , Z = d || w && 9 <= v;
    function Q(e) {
        return new RegExp("(^|\\s)" + e + "(?:$|\\s)\\s*")
    }
    var J = function(e, t) {
        var n, r = e.className, t = Q(t).exec(r);
    ...
    var oe = document.createRange ? function(e, t, n, r) {
    ...
    var ce = 50
        ...
        , de = {
        scroll: !(ue.prototype.set = function(e, t) {
                this.f = t;
                t = +new Date + e;
    ...
    function be() {}
    function we(e, t) {
        e = Object.create ? Object.create(e) : (be.prototype = e,
            new be);
        return t && ae(t, e),
            e
    }
    ...
    function Ce(e) {
        return /\w/.test(e) || "" < e && (e.toUpperCase() != e.toLowerCase() || xe.test(e))
    }
    function Se(e, t) {
        return t ? !!(-1 < t.source.indexOf("\\w") && Ce(e)) || t.test(e) : Ce(e)
    }
    function Le(e) {
        for (var t in e)
    ...
    function Te(e) {
        return 768 <= e.charCodeAt(0) && ke.test(e)
    }
    function Me(e, t, n) {
        for (; (n < 0 ? 0 < t : t < e.length) && Te(e.charAt(t)); )
            t += n;
        return t
    }
    function Ne(e, t, n) {
    ...
    De = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/,
        ...
        Fe = /[Lb1n]/,
        Pe = /[1n]/;
    var De, We, He, Fe, Pe, Ee = function(e, t) {
        var n = "ltr" == t ? "L" : "R";
        if (0 == e.length || "ltr" == t && !De.test(e))
            return !1;
        ...
        for (var L = 0; L < i; ++L)
            if (We.test(o[L])) {
                for (var k = void 0, k = L + 1; k < i && We.test(o[k]); ++k)
                    ;
        ...
        for (var O, A = [], D = 0; D < i; )
            if (Fe.test(o[D])) {
                ...
                for (var P = W; P < D; )
                    if (Pe.test(o[P])) {
                        W < P && (A.splice(H, 0, new Ie(1,W,P)),
                            H += F);
                        var I = P;
                        for (++P; P < D && Pe.test(o[P]); ++P)
                            ;
                        A.splice(H, 0, new Ie(2,I,P)),
                            H += F,
                            W = P
                    } else
                        ++P;
                W < D && A.splice(H, 0, new Ie(1,W,D))
            }
        ...
        1 == R(A).level && (O = e.match(/\s+$/)) && (R(A).to -= O[0].length,
            A.push(new Ie(0,i - O[0].length,i)))),
            "rtl" == t ? A.reverse() : A
    };
    function Ie(e, t, n) {
        this.level = e,
    ...
    function Re(e, t) {
        var n = e.order;
        return n = null == n ? e.order = Ee(e.text, t) : n
    }
    var ze = []
        , k = function(e, t, n) {
        e.addEventListener ? e.addEventListener(t, n, !1) : e.attachEvent ? e.attachEvent("on" + t, n) : (e = e._handlers || (e._handlers = {}))[t] = (e[t] || ze).concat(n)
    };
    function Be(e, t) {
    ...
    var Qe = 3 != "\n\nb".split(/\n/).length ? function(e) {
        ...
        , Je = window.getSelection ? function(e) {
            try {
        ...
        , et = "oncopy"in (l = M("div")) || (l.setAttribute("oncopy", "return;"),
    "function" == typeof l.oncopy)
        , tt = null;
    var nt = {}
        , rt = {};
    function it(e) {
        if ("string" == typeof e && rt.hasOwnProperty(e))
            e = rt[e];
        else if (e && "string" == typeof e.name && rt.hasOwnProperty(e.name)) {
            var t = rt[e.name];
            (e = we(t = "string" == typeof t ? {
                name: t
            } : t, e)).name = t.name
        } else {
            if ("string" == typeof e && /^[\w\-]+\/[\w\-]+\+xml$/.test(e))
                return it("application/xml");
            if ("string" == typeof e && /^[\w\-]+\/[\w\-]+\+json$/.test(e))
                return it("application/json")
        }
    ...
    var lt = {};
    function st(e, t) {
        ae(t, lt.hasOwnProperty(e) ? lt[e] : lt[e] = {})
    }
    function at(e, t) {
        if (!0 === t)
            return t;
    ...
    function kt(t, n, r, e) {
        for (var a = [t.state.modeGen], i = {}, u = (Ft(t, n.text, t.doc.mode, r, function(e, t) {
            a.push(e, t)
        }, i, e),
            ...
            !function(e) {
                ...
                var o = t.state.overlays[e]
                    ...
                    , s = 0;
                r.state = !0,
                    Ft(t, n.text, o.mode, r, function(e, t) {
                        for (var n = l; s < e; ) {
                            var r = a[l];
    ...
    function Tt(e, t, n) {
        var r, i, o;
        return t.styles && t.styles[0] == e.state.modeGen || (r = Mt(e, H(t)),
    ...
    function Mt(n, r, e) {
        ...
        var o = function(e, t, n) {
            for (var r, i, o = e.doc, l = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), s = t; l < s; --s) {
                ...
                var a = W(o, s - 1)
                    , u = a.stateAfter;
                if (u && (!n || s + (u instanceof St ? u.lookAhead : 0) <= o.modeFrontier))
                    return s;
            ...
            , s = l ? Lt.fromSaved(t, l, o) : new Lt(t,ct(t.mode),o);
    ...
    Lt.prototype.lookAhead = function(e) {
        ...
        ,
        Lt.fromSaved = function(e, t, n) {
            return t instanceof St ? new Lt(e,at(e.mode, t.state),n,t.lookAhead) : new Lt(e,at(e.mode, t),n)
        }
        ,
        Lt.prototype.save = function(e) {
            e = !1 !== e ? at(this.doc.mode, this.state) : this.state;
            return 0 < this.maxLookAhead ? new St(e,this.maxLookAhead) : e
        }
    ;
    ...
    function Wt(e, t, n, r) {
        var i, o, l = e.doc, s = l.mode, a = W(l, (t = E(l, t)).line), u = Mt(e, t.line, n), c = new g(a.text,e.options.tabSize,u);
        for (r && (o = []); (r || c.pos < t.ch) && !c.eol(); )
            c.start = c.pos,
                i = At(s, c, u.state),
            r && o.push(new Dt(c,i,at(l.mode, u.state)));
        return r ? o : new Dt(c,i,u.state)
    }
    function Ht(e, t) {
        if (e)
            for (; ; ) {
    ...
    function Ft(e, t, n, r, i, o, l) {
        ...
        for ("" == t && Ht(Ot(n, r.state), o); !c.eol(); ) {
            var d, f = c.pos > e.options.maxHighlightLength ? (s = !1,
            l && Nt(e, t, r, c.pos),
                c.pos = t.length,
                null) : Ht(At(n, c, r.state, h), o);
    ...
    function zt(e, t) {
        if (t.full)
            return null;
        var n = gt(e, t.from.line) && W(e, t.from.line).markedSpans
            , e = gt(e, t.to.line) && W(e, t.to.line).markedSpans;
        if (!n && !e)
            return null;
        var r = t.from.ch
            , i = t.to.ch
            ...
            if (e)
                for (var i = 0; i < e.length; ++i) {
                    ...
                    !(null == l.from || (s.inclusiveLeft ? l.from <= t : l.from < t)) && (l.from != t || "bookmark" != s.type || n && l.marker.insertLeft) || (o = null == l.to || (s.inclusiveRight ? l.to >= t : l.to > t),
                        (r = r || []).push(new It(s,l.from,o ? null : l.to)))
                }
            return r
        }(n, r, o)
            , s = function(e, t, n) {
            ...
            if (e)
                for (var i = 0; i < e.length; ++i) {
                    ...
                    !(null == l.to || (s.inclusiveRight ? l.to >= t : l.to > t)) && (l.from != t || "bookmark" != s.type || n && !l.marker.insertLeft) || (o = null == l.from || (s.inclusiveLeft ? l.from <= t : l.from < t),
                        (r = r || []).push(new It(s,o ? null : l.from - t,null == l.to ? null : l.to - t)))
                }
            return r
        }(e, i, o)
            , a = 1 == t.text.length
            , u = R(t.text).length + (a ? r : 0);
        if (l)
        ...
        if (s)
            for (var f = 0; f < s.length; ++f) {
                var p = s[f];
                null != p.to && (p.to += u),
                    null == p.from ? Rt(l, p.marker) || (p.from = u,
        ...
        if (!a) {
            ...
            if (0 < v && l)
                for (var y = 0; y < l.length; ++y)
                    null == l[y].to && (m = m || []).push(new It(l[y].marker,null,null));
            for (var b = 0; b < v; ++b)
                g.push(m);
            g.push(s)
        }
    ...
    function jt(e, t) {
        ...
        var n = e.find()
            , r = t.find()
            , i = P(n.from, r.from) || Vt(e) - Vt(t);
        if (i)
            return -i;
        i = P(n.to, r.to) || Kt(e) - Kt(t);
        return i || t.id - e.id
    }
    function Xt(e, t) {
        var n, r = Et && e.markedSpans;
        if (r)
            for (var i, o = 0; o < r.length; ++o)
                (i = r[o]).marker.collapsed && null == (t ? i.from : i.to) && (!n || jt(n, i.marker) < 0) && (n = i.marker);
        return n
    }
    function Yt(e) {
        return Xt(e, !0)
            ...
            for (var l = 0; l < o.length; ++l) {
                ...
                if (s.marker.collapsed) {
                    var a = s.marker.find(0)
                        , u = P(a.from, n) || Vt(s.marker) - Vt(i)
                        , c = P(a.to, r) || Kt(s.marker) - Kt(i);
    ...
    function tn(e) {
        if (0 == e.height)
            return 0;
        for (var t, n = e.text.length, r = e; t = Yt(r); ) {
            var i = t.find(0, !0)
                , r = i.from.line;
            n += i.from.ch - i.to.ch
        }
        ...
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
            ...
            function(e) {
                ...
                var t = y(e, document.createTextNode("AخA"))
                    , n = oe(t, 0, 1).getBoundingClientRect()
                    , t = oe(t, 1, 2).getBoundingClientRect();
                return ee(e),
                n && n.left != n.right && (qe = t.right - n.right < 3)
                ...
                if (r)
                    for (var l, s, a, u, c, h, d, f = i.length, p = 0, g = 1, m = "", v = 0; ; ) {
                        if (v == p) {
                            ...
                            if (!h || h.from == p)
                                for (var k = 0; k < y.length; ++k)
                                    hn(t, 0, y[k]);
                            if (h && (h.from || 0) == p) {
                                if (hn(t, (null == h.to ? f + 1 : h.to) - p, h.marker, null == h.from),
                                null == h.to)
                                    return;
                                h.to == p && (h = !1)
                            }
                        ...
                        for (var T = Math.min(f, v); ; ) {
                            ...
                            m = i.slice(o, o = n[g++]),
                                l = sn(n[g++], t.cm.options)
                        }
                    }
                else
                    for (var O = 1; O < n.length; O += 2)
                        t.addToken(t, i.slice(o, o = n[O]), sn(n[O + 1], t.cm.options))
            }(o, r, Tt(e, o, l)),
            o.styleClasses && (o.styleClasses.bgClass && (r.bgClass = ie(o.styleClasses.bgClass, r.bgClass || "")),
            o.styleClasses.textClass && (r.textClass = ie(o.styleClasses.textClass, r.textClass || ""))),
            0 == r.map.length && r.map.push(0, 0, r.content.appendChild((l = e.display.measure,
                o = void 0,
            null == _e && (o = M("span", "​"),
                y(l, M("span", [o, document.createTextNode("x")])),
            0 != l.firstChild.offsetHeight && (_e = o.offsetWidth <= 1 && 2 < o.offsetHeight && !(w && v < 8))),
                (l = _e ? M("span", "​") : M("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px")).setAttribute("cm-text", ""),
                l))),
            ...
            if (a.test(t))
                for (var c = document.createDocumentFragment(), h = 0; ; ) {
                    ...
                    "\t" == d[0] ? (f = (f = e.cm.options.tabSize) - e.col % f,
                        (p = c.appendChild(M("span", ve(f), "cm-tab"))).setAttribute("role", "presentation"),
    ...
    function dn(e, t, n) {
        this.line = t,
            ...
            this.size = this.rest ? H(R(this.rest)) - n + 1 : 1,
            this.node = this.text = null,
            this.hidden = Jt(e, t)
    }
    function fn(e, t, n) {
        for (var r = [], i = t; i < n; i = l) {
            var o = new dn(e.doc,W(e.doc, i),i)
                , l = i + o.size;
            r.push(o)
        }
        return r
    ...
    function b(e, t) {
        var n = Be(e, t);
        if (n.length)
            for (var r, i = Array.prototype.slice.call(arguments, 2), o = (pn ? r = pn.delayedCallbacks : gn ? r = gn : (r = gn = [],
                setTimeout(mn, 0)),
                0); o < n.length; ++o)
                !function(e) {
                    r.push(function() {
    ...
    function vn(e, t, n, r) {
        for (var i = 0; i < t.changes.length; i++) {
            ...
            if ("text" == o) {
                ...
                for (var h = Q("CodeMirror-linewidget"), d = c.node.firstChild, f = void 0; d; d = f)
                    f = d.nextSibling,
    ...
    function wn(e, t) {
        ...
        (i = (n = t).bgClass ? n.bgClass + " " + (n.line.bgClass || "") : n.line.bgClass) && (i += " CodeMirror-linebackground"),
            n.background ? i ? n.background.className = i : (n.background.parentNode.removeChild(n.background),
                n.background = null) : i && (r = yn(n),
                n.background = r.insertBefore(M("div", null, i), r.firstChild),
                e.display.input.setUneditable(n.background)),
            t.line.wrapClass ? yn(t).className = t.line.wrapClass : t.node != t.text && (t.node.className = "");
    ...
    function xn(e, t, n, r) {
        ...
        if (e.options.lineNumbers || i) {
            ...
            !e.options.lineNumbers || i && i["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(M("div", mt(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))),
                i)
    ...
    function Sn(e, t, n, r, i) {
        if (t.widgets)
            for (var o = yn(n), l = 0, s = t.widgets; l < s.length; ++l) {
                var a = s[l]
    ...
    function Ln(e) {
        if (null != e.height)
            return e.height;
        var t, n = e.doc.cm;
        return n ? (ne(document.body, e.node) || (t = "position: relative;",
    ...
    function kn(e, t) {
        for (var n = Ye(t); n != e.wrapper; n = n.parentNode)
    ...
    function On(e) {
        return ce - e.display.nativeBarWidth
    }
    function An(e) {
    ...
    function Pn(e, t) {
        var n, r, i = H(t), o = Fn(e, i), e = (o && !o.text ? o = null : o && o.changes && (vn(e, o, i, lr(e)),
            e.curOp.forceUpdate = !0),
        o || (e = e,
            r = H(n = qt(n = t)),
            (n = e.display.externalMeasured = new dn(e.doc,n,r)).lineN = r,
            r = n.built = an(e, n),
            n.text = r.pre,
    ...
    function En(e, t, n, r, i) {
        ...
        if (t.cache.hasOwnProperty(l))
            ...
            (o = function(e, t, n, r) {
                var i, o = zn(t.map, n, r), l = o.node, s = o.start, a = o.end, u = o.collapse;
                if (3 == l.nodeType) {
                    for (var c = 0; c < 4; c++) {
                        for (; s && Te(t.line.text.charAt(o.coverStart + s)); )
                            --s;
                        for (; o.coverStart + a < o.coverEnd && Te(t.line.text.charAt(o.coverStart + a)); )
                            ++a;
                        if ((i = w && v < 9 && 0 == s && a == o.coverEnd - o.coverStart ? l.parentNode.getBoundingClientRect() : function(e, t) {
                            ...
                            if ("left" == t)
                                ...
                                for (var i = e.length - 1; 0 <= i && (n = e[i]).left == n.right; i--)
                                    ;
                            return n
                        }(oe(l, s, a).getClientRects(), r)).left || i.right || 0 == s)
                            break;
                        a = s,
                            s -= 1,
                            u = "right"
                    ...
                    w && v < 11 && (i = function(e, t) {
                        if (!window.screen || null == screen.logicalXDPI || screen.logicalXDPI == screen.deviceXDPI || !function(e) {
                            ...
                            return tt = 1 < Math.abs(t.left - e.left)
                        }(e))
                            return t;
    ...
    function Vn() {
        return c && Y ? -(document.body.getBoundingClientRect().left - parseInt(getComputedStyle(document.body).marginLeft)) : window.pageXOffset || (document.documentElement || document.body).scrollLeft
    }
    function Kn() {
        return c && Y ? -(document.body.getBoundingClientRect().top - parseInt(getComputedStyle(document.body).marginTop)) : window.pageYOffset || (document.documentElement || document.body).scrollTop
    }
    function jn(e) {
        var t = qt(e).widgets
            , n = 0;
    ...
    function Xn(e, t, n, r, i) {
        ...
        r = r || "local";
        i = en(t);
        return "local" == r ? i += Tn(e.display) : i -= e.display.viewOffset,
        "page" != r && "window" != r || (i += (t = e.display.lineSpace.getBoundingClientRect()).top + ("window" == r ? 0 : Kn()),
            e = t.left + ("window" == r ? 0 : Vn()),
            n.left += e,
            n.right += e),
            n.top += i,
            n.bottom += i,
    ...
    function Yn(e, t, n) {
        ...
        var r = t.left
            , t = t.top
            , n = ("page" == n ? (r -= Vn(),
            t -= Kn()) : "local" != n && n || (r += (n = e.display.sizer.getBoundingClientRect()).left,
            t += n.top),
    ...
    function $n(e, t, n, r, i) {
        return Xn(e, r = r || W(e.doc, t.line), Hn(e, r, t.ch, i), n)
    }
    function _n(n, e, r, i, o, l) {
        function s(e, t) {
            e = En(n, o, e, t ? "right" : "left", l);
    ...
    function qn(e, t) {
        var n = 0
            , t = (t = E(e.doc, t),
        e.options.lineWrapping || (n = or(e.display) * t.ch),
            W(e.doc, t.line))
            , e = en(t) + Tn(e.display);
        return {
            left: n,
    ...
    function Qn(e, t, n) {
        ...
        if ((n += e.display.viewOffset) < 0)
            return Zn(r.first, 0, null, -1, -1);
        var i = pt(r, n)
            , o = r.first + r.size - 1;
        if (o < i)
            return Zn(r.first + r.size - 1, W(r, o).text.length, null, 1, 1);
        t < 0 && (t = 0);
        for (var l = W(r, i); ; ) {
            var s = function(n, e, t, r, i) {
                ...
                c && (c = (n.options.lineWrapping ? rr : nr)(n, e, t, o, c, r, i),
                    u = 1 != c.level,
                    s = u ? c.from : c.to - 1,
                    a = u ? c.to : c.from - 1);
                var h = null
                    ...
                    return t.top += l,
                        t.bottom += l,
                    tr(t, r, i, !1) && (t.top <= i && t.left <= r && (h = e,
                        d = t),
                        1)
                }, s, a)
                    , f = !1;
                {
                    ...
                    d ? (p = r - d.left < d.right - r,
                        ...
                        g = 0 == c || c != e.text.length && En(n, o, c - (u ? 1 : 0)).bottom + l <= i == u ? "after" : "before",
                        a = _n(n, F(t, c, g), "line", e, o),
                        p = a.left,
                        f = i < a.top ? -1 : i >= a.bottom ? 1 : 0)
                }
                return c = Me(e.text, c, 1),
                    Zn(t, c, g, f, r - p)
            }(e, l, i, t, n)
                , a = function(e, t) {
                var n, r = Et && e.markedSpans;
                if (r)
                    for (var i = 0; i < r.length; ++i) {
                        var o = r[i];
                        o.marker.collapsed && (null == o.from || o.from < t) && (null == o.to || o.to > t) && (!n || jt(n, o.marker) < 0) && (n = o.marker)
                    }
                return n
    ...
    function Jn(t, e, n, r) {
        ...
        var e = e.text.length
            , i = Ne(function(e) {
            return En(t, n, e - 1).bottom <= r
        }, e, 0);
        return {
            begin: i,
            end: Ne(function(e) {
                return En(t, n, e).top > r
            }, i, e)
        }
    }
    function er(e, t, n, r) {
        return Jn(e, t, n = n || Pn(e, t), Xn(e, t, En(e, n, r), "line").top)
    }
    function tr(e, t, n, r) {
        return !(e.bottom <= n) && (e.top > n || (r ? e.left : e.right) > t)
    }
    function nr(n, r, i, o, l, s, a) {
        var e, t = Ne(function(e) {
            var e = l[e]
                , t = 1 != e.level;
            return tr(_n(n, F(i, t ? e.to : e.from, t ? "before" : "after"), "line", r, o), s, a, !0)
        }, 0, l.length - 1), u = l[t];
        return 0 < t && (e = 1 != u.level,
        tr(e = _n(n, F(i, e ? u.from : u.to, e ? "after" : "before"), "line", r, o), s, a, !0) && e.top > a && (u = l[t - 1])),
            u
    }
    function rr(e, t, n, r, i, o, l) {
        for (var l = Jn(e, t, r, l), s = l.begin, a = l.end, u = (/\s/.test(t.text.charAt(a - 1)) && a--,
            null), c = null, h = 0; h < i.length; h++) {
            var d, f = i[h];
            f.from >= a || f.to <= s || (d = (d = En(e, r, 1 != f.level ? Math.min(a, f.to) - 1 : Math.max(s, f.from)).right) < o ? o - d + 1e9 : d - o,
            (!u || d < c) && (u = f,
                c = d))
        }
    ...
    function ir(e) {
        ...
        if (null == In) {
            In = M("pre", null, "CodeMirror-line-like");
            for (var t = 0; t < 49; ++t)
    ...
    function ar(r) {
        var i = ir(r.display)
            ...
            , l = o && Math.max(5, r.display.scroller.clientWidth / or(r.display) - 3);
        return function(e) {
            if (Jt(r.doc, e))
                return 0;
            var t = 0;
    ...
    function cr(e, t, n, r) {
        var i = e.display;
        if (!n && "true" == Ye(t).getAttribute("cm-not-content"))
            return null;
        ...
        return r && 0 < i.xRel && (t = W(e.doc, i.line).text).length == i.ch && (n = S(t, t.length, e.options.tabSize) - t.length,
            i = F(i.line, Math.max(0, Math.round((o - Nn(e.display).left) / or(e.display)) - n))),
            i
    }
    function hr(e, t) {
    ...
    function I(e, t, n, r) {
        ...
        var i, o = e.display, l = ((r = r || 0) && n < o.viewTo && (null == o.updateLineNumbers || o.updateLineNumbers > t) && (o.updateLineNumbers = t),
            ...
            t >= o.viewTo ? Et && Zt(e.doc, t) < o.viewTo && fr(e) : n <= o.viewFrom ? Et && Qt(e.doc, n + r) > o.viewFrom ? fr(e) : (o.viewFrom += r,
                o.viewTo += r) : t <= o.viewFrom && n >= o.viewTo ? fr(e) : t <= o.viewFrom ? (l = pr(e, n, n + r, 1)) ? (o.view = o.view.slice(l.index),
                o.viewFrom = l.lineN,
                o.viewTo += r) : fr(e) : n >= o.viewTo ? (l = pr(e, t, t, -1)) ? (o.view = o.view.slice(0, l.index),
                o.viewTo = l.lineN) : fr(e) : (l = pr(e, t, t, -1),
                i = pr(e, n, n + r, 1),
                l && i ? (o.view = o.view.slice(0, l.index).concat(fn(e, l.lineN, i.lineN)).concat(o.view.slice(i.index)),
                    o.viewTo += r) : fr(e)),
            o.externalMeasured);
    ...
    function dr(e, t, n) {
        ...
        t < r.viewFrom || t >= r.viewTo || null != (i = r.view[hr(e, t)]).node && -1 == L(r = i.changes || (i.changes = []), n) && r.push(n)
    }
    function fr(e) {
    ...
    function pr(e, t, n, r) {
        var i, o = hr(e, t), l = e.display.view;
        if (!Et || n == e.doc.first + e.doc.size)
            return {
                index: o,
                lineN: n
            };
    ...
    function vr(e, t) {
        ...
        for (var s, a, u, c = 0; c < n.sel.ranges.length; c++)
            !t && c == n.sel.primIndex || ((s = n.sel.ranges[c]).from().line >= e.display.viewTo || s.to().line < e.display.viewFrom || (a = s.empty(),
                l ? (u = l(e, s)) && yr(e, u, i) : (a || e.options.showCursorWhenSelecting) && yr(e, s.head, i),
            a || function(i, e, t) {
                var n = i.display
                    , o = i.doc
                    ...
                    , r = Nn(i.display)
                    , S = r.left
                    , L = Math.max(n.sizerWidth, An(i) - n.sizer.offsetLeft) - r.right
                    , k = "ltr" == o.direction;
                function T(e, t, n, r) {
                    t < 0 && (t = 0),
                        t = Math.round(t),
    ...
    function yr(e, t, n) {
        ...
        /\bcm-fat-cursor\b/.test(e.getWrapperElement().className) && (t = (t = $n(e, t, "div", null, null)).right - t.left,
            ...
            if (!s.hidden) {
                ...
                if ((.005 < a || a < -.005) && (i < r && (o -= a),
                    ...
                    for (var d = 0; d < s.rest.length; d++)
                        Tr(s.rest[d]);
                c > e.display.sizerWidth && ((a = Math.ceil(c / or(e.display))) > e.display.maxLineLength && (e.display.maxLineLength = a,
    ...
    function Mr(e, t, n) {
        var r, i = n && null != n.top ? Math.max(0, n.top) : e.scroller.scrollTop, i = Math.floor(i - Tn(e)), o = n && null != n.bottom ? n.bottom : i + e.wrapper.clientHeight, i = pt(t, i), o = pt(t, o);
        return n && n.ensure && (r = n.ensure.from.line,
            n = n.ensure.to.line,
            r < i ? o = pt(t, en(W(t, i = r)) + e.wrapper.clientHeight) : Math.min(n, t.lastLine()) >= o && (i = pt(t, en(W(t, n)) - e.wrapper.clientHeight),
                o = n)),
            {
                from: i,
                to: Math.max(o, i + 1)
    ...
    function Wr(e) {
        ...
        t && (e.curOp.scrollToPos = null,
            Hr(e, qn(e, t.from), qn(e, t.to), t.margin))
    }
    function Hr(e, t, n, r) {
        t = Nr(e, {
        ...
        Dr(e, t.scrollLeft, t.scrollTop)
    }
    function Fr(e, t) {
        Math.abs(e.doc.scrollTop - t) < 2 || (d || Qr(e, {
            top: t
        }),
            Pr(e, t, !0),
        d && Qr(e),
    ...
    Rr.prototype.update = function(e) {
        ...
        Rr.prototype.zeroWidthHack = function() {
            this.horiz.style.height = this.vert.style.width = C && !K ? "12px" : "18px",
    ...
    function Br(e, t) {
        ...
        for (var i = 0; i < 4 && n != e.display.barWidth || r != e.display.barHeight; i++)
            n != e.display.barWidth && e.options.lineWrapping && kr(e),
                Gr(e, Ir(e)),
    ...
    function Vr(n) {
        ...
        n.display.scrollbars.addClass && J(n.display.wrapper, n.display.scrollbars.addClass)),
            n.display.scrollbars = new Ur[n.options.scrollbarStyle](function(e) {
                ...
                ,function(e, t) {
                    ("horizontal" == t ? Er : Fr)(n, e)
                }
                ,n),
        n.display.scrollbars.addClass && re(n.display.wrapper, n.display.scrollbars.addClass)
    }
    var Kr = 0;
    function jr(e) {
        e.curOp = {
            ...
            var t = function(e) {
                ...
                for (var n = e.ops, r = 0; r < n.length; r++) {
                    ...
                    i.updateMaxLine && nn(o),
                        ...
                        i.update = i.mustUpdate && new _r(o,i.mustUpdate && {
                            top: i.scrollTop,
                ...
                for (var s = 0; s < n.length; s++) {
                    a = void 0;
                    var a = n[s];
                    a.updatedDisplay = a.mustUpdate && qr(a.cm, a.update)
                }
                for (var u = 0; u < n.length; u++) {
                    ...
                    var h = c.cm
                        , d = h.display;
                    c.updatedDisplay && kr(h);
                    c.barMeasure = Ir(h),
                    d.maxLineChanged && !h.options.lineWrapping && (c.adjustWidthTo = Hn(h, d.maxLine, d.maxLine.text.length).left + 3,
                        h.display.sizerWidth = c.adjustWidthTo,
                        c.barMeasure.scrollWidth = Math.max(d.scroller.clientWidth, d.sizer.offsetLeft + c.adjustWidthTo + On(h) + h.display.barWidth),
                        c.maxScrollLeft = Math.max(0, d.sizer.offsetLeft + c.adjustWidthTo - An(h)));
                ...
                for (var f = 0; f < n.length; f++) {
                    ...
                    p.maxScrollLeft < g.doc.scrollLeft && Er(g, Math.min(g.display.scroller.scrollLeft, p.maxScrollLeft), !0),
                        g.display.maxLineChanged = !1);
                    var m = p.focus && p.focus == N();
                    p.preparedSelection && g.display.input.showSelection(p.preparedSelection, m);
                    !p.updatedDisplay && p.startHeight == g.doc.height || Br(g, p.barMeasure);
                    p.updatedDisplay && ei(g, p.barMeasure);
                    p.selectionChanged && wr(g);
                ...
                for (var v, y = 0; y < n.length; y++) {
                    ...
                    var w = b.cm
                        , x = w.display
                        , C = w.doc;
                    b.updatedDisplay && Zr(w, b.update);
                    ...
                    null != b.scrollLeft && Er(w, b.scrollLeft, !0, !0);
                    b.scrollToPos && (v = function(e, t, n, r) {
                        ...
                        for (var i = 0; i < 5; i++) {
                            var o, l = !1, s = _n(e, t), a = n && n != t ? _n(e, n) : s, s = Nr(e, o = {
                            ...
                            if (null != s.scrollTop && (Fr(e, s.scrollTop),
                            1 < Math.abs(e.doc.scrollTop - a) && (l = !0)),
                            null != s.scrollLeft && (Er(e, s.scrollLeft),
    ...
    function Yr(e, t) {
        e.doc.highlightFrontier < e.display.viewTo && e.state.highlight.set(t, se($r, e))
    }
    function $r(l) {
        var s, a, u, c = l.doc;
        c.highlightFrontier >= l.display.viewTo || (s = +new Date + l.options.workTime,
            ...
            c.iter(a.line, Math.min(c.first + c.size, l.display.viewTo + 500), function(e) {
                if (a.line >= l.display.viewFrom) {
                    for (var t = e.styles, n = e.text.length > l.options.maxHighlightLength ? at(c.mode, a.state) : null, r = kt(l, e, a, !0), n = (n && (a.state = n),
                        e.styles = r.styles,
                    ...
                    e.text.length <= l.options.maxHighlightLength && Nt(l, e.text, a),
                        e.stateAfter = a.line % 5 == 0 ? a.save() : null,
                        a.nextLine();
                if (+new Date > s)
                    return Yr(l, l.options.workDelay),
                        !0
            }),
    ...
    function qr(e, t) {
        ...
        o != n.viewFrom || l != n.viewTo || n.lastWrapHeight != t.wrapperHeight || n.lastWrapWidth != t.wrapperWidth)
            , i = (i = o,
            o = l,
            0 == (c = (l = e).display).view.length || i >= c.viewTo || o <= c.viewFrom ? (c.view = fn(l, i, o),
                c.viewFrom = i) : (c.viewFrom > i ? c.view = fn(l, i, c.viewFrom).concat(c.view) : c.viewFrom < i && (c.view = c.view.slice(hr(l, i))),
                c.viewFrom = i,
                c.viewTo < o ? c.view = c.view.concat(fn(l, c.viewTo, o)) : c.viewTo > o && (c.view = c.view.slice(0, hr(l, o)))),
            c.viewTo = o,
            n.viewOffset = en(W(e.doc, n.viewFrom)),
        ...
        var l = function(e) {
            if (e.hasFocus())
                return null;
            if (!(n = N()) || !ne(e.display.lineDiv, n))
                return null;
            var t, n = {
                activeElt: n
            };
            return window.getSelection && (t = window.getSelection()).anchorNode && t.extend && ne(e.display.lineDiv, t.anchorNode) && (n.anchorNode = t.anchorNode,
            ...
            if (!y.hidden)
                if (y.node && y.node.parentNode == d) {
                    ...
                    y.changes && (-1 < L(y.changes, "gutter") && (b = !1),
                        vn(s, y, m, u)),
                    b && (ee(y.lineNumber),
                        y.lineNumber.appendChild(document.createTextNode(mt(s.options, m)))),
        ...
        (o = l) && o.activeElt && o.activeElt != N() && (o.activeElt.focus(),
        !/^(INPUT|TEXTAREA)$/.test(o.activeElt.nodeName) && o.anchorNode && ne(document.body, o.anchorNode) && ne(document.body, o.focusNode) && (c = window.getSelection(),
    ...
    function Zr(e, t) {
        for (var n = t.viewport, r = !0; ; r = !1) {
            if (r && e.options.lineWrapping && t.oldDisplayWidth != An(e))
                r && (t.visible = Mr(e.display, e.doc, n));
            else if (n && null != n.top && (n = {
                top: Math.min(e.doc.height + Mn(e.display) - Dn(e), n.top)
            }),
                t.visible = Mr(e.display, e.doc, n),
    ...
    function ti(e) {
        ...
        if (t.alignWidgets || t.gutters.firstChild && e.options.fixedGutter) {
            for (var r = sr(t) - t.scroller.scrollLeft + e.doc.scrollLeft, i = t.gutters.offsetWidth, o = r + "px", l = 0; l < n.length; l++)
                if (!n[l].hidden) {
    ...
    function ni(e) {
        ...
        if (e.options.lineNumbers)
            return t = e.doc,
                t = mt(e.options, t.first + t.size - 1),
                n = e.display,
    ...
    function li(e, t, n, r) {
        var i = this
            ...
            i.lineSpace = te("div", [i.measure, i.lineMeasure, i.selectionDiv, i.cursorDiv, i.lineDiv], null, "position: relative; outline: none"),
            te("div", [i.lineSpace], "CodeMirror-lines"));
        i.mover = M("div", [o], null, "position: relative"),
            i.sizer = M("div", [i.mover], "CodeMirror-sizer"),
            i.sizerWidth = null,
            i.heightForcer = M("div", null, null, "position: absolute; height: " + ce + "px; width: 1px;"),
        ...
        e && (e.appendChild ? e.appendChild(i.wrapper) : e(i.wrapper)),
            ...
            i.activeTouch = null,
            i.gutterSpecs = ri(r.gutters, r.lineNumbers),
            ii(i),
            n.init(i)
    }
    _r.prototype.signal = function(e, t) {
    ...
    function hi(e, t) {
        ...
        if (r && s || n && a) {
            ...
            if (r && !d && !m && null != i)
                return n && a && Fr(e, Math.max(0, l.scrollTop + n * i)),
                    Er(e, Math.max(0, l.scrollLeft + r * i)),
                n && !a || D(t),
            ...
            si < 20 && 0 !== t.deltaMode && (null == o.wheelStartX ? (o.wheelStartX = l.scrollLeft,
    ...
    w ? ai = -.53 : d ? ai = 15 : c ? ai = -.7 : V && (ai = -1 / 3);
    var B = function(e, t) {
        this.ranges = e,
            this.primIndex = t
    }
        , G = (B.prototype.primary = function() {
            ...
            B.prototype.equals = function(e) {
                ...
                for (var t = 0; t < this.ranges.length; t++) {
                    var n = this.ranges[t]
                        , r = e.ranges[t];
                    if (!vt(n.anchor, r.anchor) || !vt(n.head, r.head))
                        return !1
                }
                return !0
            }
            ...
            B.prototype.deepCopy = function() {
                for (var e = [], t = 0; t < this.ranges.length; t++)
                    e[t] = new G(yt(this.ranges[t].anchor),yt(this.ranges[t].head));
    ...
    function di(e, t, n) {
        ...
        for (var i = 1; i < t.length; i++) {
            ...
            (r && !l.empty() ? 0 < a : 0 <= a) && (a = wt(s.from(), l.from()),
                o = bt(s.to(), l.to()),
    ...
    function pi(e) {
        return e.text ? F(e.from.line + e.text.length - 1, R(e.text).length + (1 == e.text.length ? e.from.ch : 0)) : e.to
    }
    function gi(e, t) {
        if (P(e, t.from) < 0)
            return e;
        ...
        var n = e.line + t.text.length - (t.to.line - t.from.line) - 1
            , r = e.ch;
        return e.line == t.to.line && (r += pi(t).ch - t.to.ch),
            F(n, r)
    }
    function mi(e, t) {
        for (var n = [], r = 0; r < e.sel.ranges.length; r++) {
            var i = e.sel.ranges[r];
            n.push(new G(gi(i.anchor, t),gi(i.head, t)))
        }
    ...
    function yi(e) {
        e.doc.mode = ot(e.options, e.doc.modeOption),
            bi(e)
    }
    function bi(e) {
    ...
    function wi(e, t) {
        return 0 == t.from.ch && 0 == t.to.ch && "" == R(t.text) && (!e.cm || e.cm.options.wholeLineUpdateBefore)
    }
    function xi(e, o, t, l) {
        function i(e) {
            return t ? t[e] : null
        ...
        function n(e, t, n) {
            ...
            null != r.order && (r.order = null),
                Gt(r),
                Ut(r, n),
            (t = i ? i(r) : 1) != r.height && ft(r, t),
                b(e, "change", e, o)
        }
        function r(e, t) {
            for (var n = [], r = e; r < t; ++r)
                n.push(new rn(c[r],i(r),l));
            return n
        }
        var s, a = o.from, u = o.to, c = o.text, h = W(e, a.line), d = W(e, u.line), f = R(c), p = i(c.length - 1), g = u.line - a.line;
        o.full ? (e.insert(0, r(0, c.length)),
            e.remove(c.length, e.size - c.length)) : wi(e, o) ? (s = r(0, c.length - 1),
            n(d, d.text, p),
        g && e.remove(a.line, g),
        s.length && e.insert(a.line, s)) : h == d ? 1 == c.length ? n(h, h.text.slice(0, a.ch) + f + h.text.slice(u.ch), p) : ((s = r(1, c.length - 1)).push(new rn(f + h.text.slice(u.ch),p,l)),
    ...
    function Ni(e, t, n, r) {
        var i, o, l = e.history, s = (l.undone.length = 0,
            +new Date);
        if ((l.lastOp == r || l.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && l.lastModTime > s - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (o = (o = l).lastOp == r ? (Mi(o.done),
            R(o.done)) : o.done.length && !R(o.done).ranges ? R(o.done) : 1 < o.done.length && !o.done[o.done.length - 2].ranges ? (o.done.pop(),
            R(o.done)) : void 0))
            i = R(o.changes),
                0 == P(t.from, t.to) && 0 == P(t.from, i.to) ? i.to = pi(t) : o.changes.push(Ti(e, t));
        else {
            var a = R(l.done);
            for (a && a.ranges || Ai(e.sel, l.done),
                     o = {
                         changes: [Ti(e, t)],
    ...
    function Oi(e, t, n, r) {
        ...
        n == s.lastSelOp || a && s.lastSelOrigin == a && (s.lastModTime == s.lastSelTime && s.lastOrigin == a || (e = e,
            ...
            o = R(s.done),
            l = t,
        "*" == (i = i.charAt(0)) || "+" == i && o.ranges.length == l.ranges.length && o.somethingSelected() == l.somethingSelected() && new Date - e.history.lastSelTime <= (e.cm ? e.cm.options.historyEventDelay : 500))) ? s.done[s.done.length - 1] = t : Ai(t, s.done),
            s.lastSelTime = +new Date,
            s.lastSelOrigin = a,
            s.lastSelOp = n,
        r && !1 !== r.clearRedo && Mi(s.undone)
    }
    function Ai(e, t) {
        var n = R(t);
            ...
            if (o.ranges)
                ...
                for (var a = 0; a < l.length; ++a) {
                    ...
                    if (s.push({
                        ...
                        t)
                        for (var h in c)
                            (u = h.match(/^spans_(\d+)$/)) && -1 < L(t, Number(u[1])) && (R(s)[h] = c[h],
                                delete c[h])
                }
            }
        }
    ...
    function Ii(e, t, n) {
        ...
        U(e, di(e.cm, r, e.sel.primIndex), n)
    }
    function Ri(e, t, n, r) {
        var i = e.sel.ranges.slice(0);
        i[t] = n,
            U(e, di(e.cm, i, e.sel.primIndex), r)
    }
    function zi(e, t, n, r) {
        U(e, fi(t, n), r)
    }
    function Bi(e, t, n) {
        var r = e.history.done
            , i = R(r);
        i && i.ranges ? Gi(e, r[r.length - 1] = t, n) : U(e, t, n)
    }
    function U(e, t, n) {
        Gi(e, t, n),
    ...
    function Gi(e, t, n) {
        (Ue(e, "beforeSelectionChange") || e.cm && Ue(e.cm, "beforeSelectionChange")) && (r = e,
            o = n,
            o = {
                ranges: (i = t).ranges,
                update: function(e) {
        ...
        r.cm && O(r.cm, "beforeSelectionChange", r.cm, o),
            t = o.ranges != i.ranges ? di(r.cm, o.ranges, o.ranges.length - 1) : i);
    ...
    function Vi(e) {
        Ui(e, Ki(e, e.sel, null, !1))
    }
    function Ki(e, t, n, r) {
        for (var i, o = 0; o < t.ranges.length; o++) {
            var l = t.ranges[o]
                , s = t.ranges.length == e.sel.ranges.length && e.sel.ranges[o]
                , a = Xi(e, l.anchor, s && s.anchor, n, r)
                , s = Xi(e, l.head, s && s.head, n, r);
                    ...
                    if (a.atomic) {
                        if (n) {
                            var s = a.find(r < 0 ? 1 : -1)
                                , h = void 0;
                            if ((s = (r < 0 ? c : u) ? Yi(e, s, -r, s && s.line == t.line ? o : null) : s) && s.line == t.line && (h = P(s, n)) && (r < 0 ? h < 0 : 0 < h))
                                return ji(e, s, t, r, i)
                        }
                        h = a.find(r < 0 ? -1 : 1);
                        return (h = (r < 0 ? u : c) ? Yi(e, h, r, h.line == t.line ? o : null) : h) ? ji(e, h, t, r, i) : null
                    }
                }
            }
        return t
    ...
    function Xi(e, t, n, r, i) {
        r = r || 1,
            i = ji(e, t, n, r, i) || !i && ji(e, t, n, r, !0) || ji(e, t, n, -r, i) || !i && ji(e, t, n, -r, !0);
    ...
    function $i(e) {
        e.setSelection(F(e.firstLine(), 0), F(e.lastLine()), de)
    }
    function _i(i, e, t) {
        var o = {
            canceled: !1,
    ...
    function qi(e, t, n) {
        if (e.cm) {
            if (!e.cm.curOp)
                return z(e.cm, qi)(e, t, n);
            if (e.cm.state.suppressEdits)
                return
        }
        if (!(Ue(e, "beforeChange") || e.cm && Ue(e.cm, "beforeChange")) || (t = _i(e, t, !0))) {
    ...
    function Zi(e, n) {
        var t, r;
        1 == n.text.length && "" == n.text[0] && 0 == P(n.from, n.to) || (t = mi(e, n),
            Ni(e, n, t, e.cm ? e.cm.curOp.id : NaN),
            eo(e, n, t, zt(e, n)),
            r = [],
            Ci(e, function(e, t) {
                t || -1 != L(r, e.history) || (io(e.history, n),
                    r.push(e.history)),
                    eo(e, n, null, zt(e, n))
            }))
    }
    function Qi(i, o, e) {
        ...
        if (!t || e) {
            ...
            if (u != s.length) {
                ...
                Ue(i, "beforeChange") || i.cm && Ue(i.cm, "beforeChange")), d = l.changes.length - 1; 0 <= d; --d) {
                    var f = function(e) {
                        var n = l.changes[e];
                        if (n.origin = o,
                        h && !_i(i, n, !1))
    ...
    function Ji(e, t) {
        if (0 != t && (e.first += t,
            e.sel = new B(ye(e.sel.ranges, function(e) {
    ...
    function eo(e, t, n, r) {
        if (e.cm && !e.cm.curOp)
            return z(e.cm, eo)(e, t, n, r);
        if (t.to.line < e.first)
            Ji(e, t.text.length - 1 - (t.to.line - t.from.line));
        else if (!(t.from.line > e.lastLine())) {
            t.from.line < e.first && (Ji(e, i = t.text.length - 1 - (e.first - t.from.line)),
                t = {
                    from: F(e.first, 0),
            ...
            if ((t = t.to.line > i ? {
                ...
                var i = e.cm
                    ...
                    , h = !1
                    , d = u.line
                    , f = (i.options.lineWrapping || (d = H(qt(W(s, u.line))),
                    s.iter(d, c.line + 1, function(e) {
                        if (e == a.maxLine)
                            return h = !0
                    })),
                -1 < s.sel.contains(o.from, o.to) && Ge(i),
                    xi(s, o, l, ar(i)),
                ...
                if (f.modeFrontier = Math.min(f.modeFrontier, p),
                    ...
                    for (var g = f.first, m = p - 1; g < m; m--) {
                        ...
                        if (v && (!(v instanceof St) || m + v.lookAhead < p)) {
                            g = m + 1;
                            break
                        }
                    }
                ...
                Yr(i, 400),
                    ...
                    o.full ? I(i) : u.line != c.line || 1 != o.text.length || wi(i.doc, o) ? I(i, u.line, c.line + 1, l) : dr(i, u.line, "text"),
                    d = Ue(i, "changes"),
                ((s = Ue(i, "change")) || d) && (l = {
                    from: u,
                    to: c,
                ...
                xi(e, t, r);
            Gi(e, n, de),
            e.cantEdit && Xi(e, F(e.firstLine(), 0)) && (e.cantEdit = !1)
        }
    }
        ...
        for (var i = 0; i < e.length; ++i) {
            ...
            if (o.ranges) {
                ...
                for (var s = 0; s < o.ranges.length; s++)
                    no(o.ranges[s].anchor, t, n, r),
                        no(o.ranges[s].head, t, n, r)
            } else {
    ...
    function oo(e, t, n, r) {
        var i = t
            , o = t;
        return "number" == typeof t ? o = W(e, xt(e, t)) : i = H(t),
            null == i ? null : (r(o, i) && e.cm && dr(e.cm, i, n),
                o)
    }
    function lo(e) {
        this.lines = e,
    ...
    G.prototype.from = function() {
        ...
        so.prototype = {
            ...
            removeInner: function(e, t) {
                ...
                this.size - t < 25 && (1 < this.children.length || !(this.children[0]instanceof lo)) && (this.collapse(n = []),
                    this.children = [new lo(n)],
            ...
            maybeSpill: function() {
                if (!(this.children.length <= 10)) {
                    var e = this;
                    do {
                        var t, n = new so(e.children.splice(e.children.length - 5, 5))
                    } while (e.parent ? (e.size -= n.size,
                        e.height -= n.height,
                        t = L(e.parent.children, e),
                        e.parent.children.splice(t + 1, 0, n)) : (((t = new so(e.children)).parent = e).children = [t, n],
                        e = t),
                        n.parent = e.parent,
    ...
    function uo(e, t, n) {
        en(t) < (e.curOp && e.curOp.scrollTop || e.doc.scrollTop) && Or(e, n)
    }
    ao.prototype.clear = function() {
        ...
        ao.prototype.changed = function() {
            var e = this
                ...
                , i = (this.height = null,
            Ln(this) - t);
            i && (Jt(this.doc, r) || ft(r, r.height + i),
            n && h(n, function() {
    ...
    function fo(r, i, o, e, t) {
        ...
        e.insertLeft && (d.widgetNode.insertLeft = !0)),
            d.collapsed) {
            if (_t(r, i.line, i, o, d) || i.line != o.line && _t(r, o.line, i, o, d))
        ...
        if (r.iter(g, o.line + 1, function(e) {
            var t, n;
            m && d.collapsed && !m.options.lineWrapping && qt(e) == m.display.maxLine && (p = !0),
            d.collapsed && g != i.line && ft(e, 0),
                e = e,
                t = new It(d,g == i.line ? i.ch : null,g == o.line ? o.ch : null),
    ...
    co.prototype.clear = function() {
        if (!this.explicitlyCleared) {
            for (var e, t = this.doc.cm, n = t && !t.curOp, r = (n && jr(t),
            !Ue(this, "clear") || (e = this.find()) && b(this, "clear", e.from, e.to),
                null), i = null, o = 0; o < this.lines.length; ++o) {
                var l = this.lines[o]
                    , s = Rt(l.markedSpans, this);
                t && !this.collapsed ? dr(t, H(l), "text") : t && (null != s.to && (i = H(l)),
                null != s.from && (r = H(l))),
                ...
                null == s.from && this.collapsed && !Jt(this.doc, l) && t && ft(l, ir(t.display))
            }
        ...
        co.prototype.changed = function() {
            ...
            r && o && h(o, function() {
                ...
                Jt(i.doc, e) || null == i.height || (t = i.height,
                    i.height = null,
                (t = Ln(i) - t) && ft(e, e.height + t)),
    ...
    function f(e, t, n, r, i) {
        ...
        null == n && (n = 0),
            so.call(this, [new lo([new rn("",null)])]),
            this.first = n,
    ...
    var vo = 0
        , yo = ((f.prototype = we(so.prototype, {
        constructor: f,
        iter: function(e, t, n) {
        ...
        getValue: function(e) {
            var t = dt(this, this.first, this.first + this.size);
        ...
        replaceRange: function(e, t, n, r) {
            to(this, e, t = E(this, t), n = n ? E(this, n) : t, r)
        },
        getRange: function(e, t, n) {
            e = ht(this, E(this, e), E(this, t));
        ...
        getLineHandleVisualStart: function(e) {
            return qt(e = "number" == typeof e ? W(this, e) : e)
        },
        lineCount: function() {
            return this.size
        },
        ...
        setCursor: n(function(e, t, n) {
            zi(this, E(this, "number" == typeof e ? F(e, t || 0) : e), null, n)
        }),
        setSelection: n(function(e, t, n) {
            zi(this, E(this, e), E(this, t || e), n)
        }),
        extendSelection: n(function(e, t, n) {
            Ei(this, E(this, e), t && E(this, t), n)
        }),
        extendSelections: n(function(e, t) {
            Ii(this, Ct(this, e), t)
        }),
        extendSelectionsBy: n(function(e, t) {
            Ii(this, Ct(this, ye(this.sel.ranges, e)), t)
        }),
        ...
        replaceSelections: n(function(e, t, n) {
            ...
            for (var t = t && "end" != t && function(e, t, n) {
                ...
                qi(this, r[s]);
            t ? Bi(this, t) : this.cm && Ar(this.cm)
        }),
        undo: n(function() {
            Qi(this, "undo")
        }),
        ...
        setHistory: function(e) {
            ...
            t.done = Fi(e.done.slice(0), null, !0),
                t.undone = Fi(e.undone.slice(0), null, !0)
        },
        setGutterMarker: n(function(e, n, r) {
            return oo(this, e, "gutter", function(e) {
                var t = e.gutterMarkers || (e.gutterMarkers = {});
                return !(t[n] = r) && Le(t) && (e.gutterMarkers = null),
                    1
            })
        }),
        clearGutter: n(function(t) {
            ...
            this.iter(function(e) {
                e.gutterMarkers && e.gutterMarkers[t] && oo(n, e, "gutter", function() {
                    return e.gutterMarkers[t] = null,
                    Le(e.gutterMarkers) && (e.gutterMarkers = null),
                        1
                })
            })
        }),
        ...
        addLineClass: n(function(e, n, r) {
            return oo(this, e, "gutter" == n ? "gutter" : "class", function(e) {
        ...
        removeLineClass: n(function(e, o, l) {
            return oo(this, e, "gutter" == o ? "gutter" : "class", function(e) {
        ...
        markText: function(e, t, n) {
            return fo(this, E(this, e), E(this, t), n, n && n.type || "range")
        },
        setBookmark: function(e, t) {
            ...
            return fo(this, e = E(this, e), e, t, "bookmark")
        },
        ...
        copy: function(e) {
            var t = new f(dt(this, this.first, this.first + this.size),this.modeOption,this.first,this.lineSep,this.direction);
        ...
        linkedDoc: function(e) {
            ...
            null != e.to && e.to < n && (n = e.to),
                new f(dt(this, t, n),e.mode || this.modeOption,t,this.lineSep,this.direction)), r = (e.sharedHist && (n.history = this.history),
                ...
                n), i = go(this), o = 0; o < i.length; o++) {
                var l = i[o]
                    , s = l.find()
                    , a = r.clipPos(s.from)
                    , s = r.clipPos(s.to);
                P(a, s) && (a = fo(r, a, s, l.primary, l.primary.type),
                    l.markers.push(a),
                    a.parent = l)
            }
            return n
        ...
        unlinkDoc: function(e) {
            ...
            e.history == this.history && (r = [e.id],
                ...
                e.history.done = Fi(this.history.done, r),
                e.history.undone = Fi(this.history.undone, r))
        },
        ...
        splitLines: function(e) {
            return this.lineSep ? e.split(this.lineSep) : Qe(e)
        },
                ...
                if (n && n.length && window.FileReader && window.File)
                    for (var i = n.length, o = Array(i), l = 0, s = function() {
                        ++l == i && z(r, function() {
                            ...
                            qi(r.doc, e),
                                Bi(r.doc, fi(E(r.doc, t), E(r.doc, pi(e))))
                        })()
                    }, a = 0; a < n.length; a++)
                        !function(e, t) {
                            var n;
                        ...
                        if (c) {
                            if (r.state.draggingText && !r.state.draggingText.copy && (u = r.listSelections()),
                                ...
                                for (var h = 0; h < u.length; ++h)
                                    to(r.doc, "", u[h].anchor, u[h].head, "drag");
    ...
    for (var ko = {
        ...
        ko[To + 48] = ko[To + 96] = String(To);
    for (var Mo = 65; Mo <= 90; Mo++)
        ko[Mo] = String.fromCharCode(Mo);
    for (var No = 1; No <= 12; No++)
        ko[No + 111] = ko[No + 63235] = "F" + No;
    var Oo = {};
    function Ao(e) {
            ...
            if (e.hasOwnProperty(t)) {
                ...
                if (!/^(name|fallthrough|(de|at)tach)$/.test(t))
                    if ("..." == i)
                        ...
                        for (var o = ye(t.split(" "), Ao), l = 0; l < o.length; l++) {
                            var s = void 0
                                , a = void 0
    ...
    function Wo(e, t, n, r) {
        var i = (t = Eo(t)).call ? t.call(e, r) : t[e];
        if (!1 === i)
            return "nothing";
        if ("..." === i)
            return "multi";
        ...
        if (t.fallthrough) {
            if ("[object Array]" != Object.prototype.toString.call(t.fallthrough))
                return Wo(e, t.fallthrough, n, r);
            for (var o = 0; o < t.fallthrough.length; o++) {
                var l = Wo(e, t.fallthrough[o], n, r);
                if (l)
                    return l
            }
        }
    ...
    function Ho(e) {
        e = "string" == typeof e ? e : ko[e.keyCode];
    ...
    function Po(e, t) {
        if (m && 34 == e.keyCode && e.char)
            return !1;
        var n = ko[e.keyCode];
        return null != n && !e.altGraphKey && Fo(n = 3 == e.keyCode && e.code ? e.code : n, e, t)
    }
    function Eo(e) {
        return "string" == typeof e ? Oo[e] : e
    }
    function Io(t, e) {
        for (var n = t.doc.sel.ranges, r = [], i = 0; i < n.length; i++) {
            for (var o = e(n[i]); r.length && P(o.from, R(r).to) <= 0; ) {
                var l = r.pop();
        ...
        h(t, function() {
            for (var e = r.length - 1; 0 <= e; e--)
                to(t.doc, "", r[e].from, r[e].to, "+delete");
            Ar(t)
        })
    }
    function Ro(e, t, n) {
    ...
    function Bo(e, t, n, r, i) {
        if (e) {
            ...
            if (e)
                return o = i < 0 == (1 == (e = i < 0 ? R(e) : e[0]).level) ? "after" : "before",
                    0 < e.level || "rtl" == t.doc.direction ? (l = Pn(t, n),
                        s = i < 0 ? n.text.length - 1 : 0,
                        a = En(t, l, s).top,
                        s = Ne(function(e) {
                            return En(t, l, e).top == a
                        }, i < 0 == (1 == e.level) ? e.from : e.to - 1, s),
                    "before" == o && (s = Ro(n, s, 1))) : s = i < 0 ? e.to : e.from,
                    new F(r,s,o)
        }
    ...
    function Go(t, n, s, e) {
        ...
        function o(e) {
            return t.options.lineWrapping ? (l = l || Pn(t, n),
                er(t, n, l, e)) : {
                begin: 0,
                end: n.text.length
            }
    ...
    Oo.basic = {
        ...
        Oo.default = C ? Oo.macDefault : Oo.pcDefault;
    var Uo = {
        selectAll: $i,
        singleSelection: function(e) {
            return e.setSelection(e.getCursor("anchor"), e.getCursor("head"), de)
        },
        killLine: function(n) {
        ...
        goLineLeftSmart: function(n) {
            return n.extendSelectionsBy(function(e) {
                ...
                return t.ch < n.getLine(t.line).search(/\S/) ? Ko(n, e.head) : t
            }, pe)
        },
        goLineUp: function(e) {
    ...
    function $o(e, t, n, r) {
        r = function(e, t, n) {
            for (var r = 0; r < e.state.keyMaps.length; r++) {
                var i = Wo(t, e.state.keyMaps[r], n, e);
                if (i)
                    return i
            }
            return e.options.extraKeys && Wo(t, e.options.extraKeys, n, e) || Wo(t, e.options.keyMap, n, e)
        }(e, t, r);
    ...
    function _o(t, e) {
        var n = Po(e, !0);
        return !!n && (e.shiftKey && !t.state.keySeq ? Yo(t, "Shift-" + n, e, function(e) {
            return jo(t, e, !0)
        }) || Yo(t, n, e, function(e) {
    ...
    function Zo(e) {
        var t, n, r, i = this;
        function o(e) {
            18 != e.keyCode && e.altKey || (J(r, "CodeMirror-crosshair"),
                T(document, "keyup", o),
                T(document, "mouseover", o))
        }
        e.target && e.target != i.display.input.getField() || (i.curOp.focus = N(),
        A(i, e) || (w && v < 11 && 27 == e.keyCode && (e.returnValue = !1),
            t = e.keyCode,
            i.display.shift = 16 == t || e.shiftKey,
            n = _o(i, e),
        m && (qo = n ? t : null,
        !n && 88 == t && !et && (C ? e.metaKey : e.ctrlKey) && i.replaceSelection("", null, "cut")),
        d && !C && !n && 46 == t && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"),
        18 != t || /\bCodeMirror-crosshair\b/.test(i.display.lineDiv.className) || (re(r = i.display.lineDiv, "CodeMirror-crosshair"),
            k(document, "keyup", o),
    ...
    function Jo(e) {
        var t = this;
        if (!(e.target && e.target != t.display.input.getField() || kn(t.display, e) || A(t, e) || e.ctrlKey && !e.altKey || C && e.metaKey)) {
            var n, r = e.keyCode, i = e.charCode;
            if (m && r == qo)
                return qo = null,
                    void D(e);
            m && (!e.which || e.which < 10) && _o(t, e) || ("\b" == (r = String.fromCharCode(null == i ? r : i)) || Yo(n = t, "'" + r + "'", e, function(e) {
                return jo(n, e, !0)
    ...
    function rl(e) {
        ...
        A(c, e) || h.activeTouch && h.input.supportsTouch() || (h.input.ensurePolled(),
            h.shift = e.shiftKey,
            kn(h, e) ? x || (h.scroller.draggable = !1,
                setTimeout(function() {
                ...
                r = t ? (i = t,
                    o = n,
                    r = +new Date,
                    nl && nl.compare(r, i, o) ? (tl = nl = null,
                        "triple") : tl && tl.compare(r, i, o) ? (nl = new el(r,i,o),
                        tl = null,
                        "double") : (tl = new el(r,i,o),
                        nl = null,
                        "single")) : "single",
                window.focus(),
            ...
            t && function(n, e, r, t, i) {
                ...
                return Yo(n, Fo(o = (1 == e ? "Left" : 2 == e ? "Middle" : "Right") + o, i), i, function(e) {
                    if (!(e = "string" == typeof e ? Uo[e] : e))
                        return !1;
                    var t = !1;
                    try {
                ...
                l = r,
                s = e,
                w ? setTimeout(se(xr, i), 0) : i.curOp.focus = N(),
                a = function(e, t, n) {
                    var r = e.getOption("configureMouse")
                        , r = r ? r(e, t, n) : {};
                    {
                        var i;
                        null == r.unit && (i = _ ? n.shiftKey && n.metaKey : n.altKey,
                ...
                u = i.doc.sel,
                (i.options.dragDrop && Ze && !i.isReadOnly() && "single" == l && -1 < (l = u.contains(o)) && (P((l = u.ranges[l]).from(), o) < 0 || 0 < o.xRel) && (0 < P(l.to(), o) || o.xRel < 0) ? function(t, n, r, i) {
                            var o = t.display
                                , l = !1
                                , s = z(t, function(e) {
                                x && (o.scroller.draggable = !1),
                                    t.state.draggingText = !1,
                                t.state.delayingBlurEvent && (t.hasFocus() ? t.state.delayingBlurEvent = !1 : Cr(t)),
                                    T(o.wrapper.ownerDocument, "mouseup", s),
                                    T(o.wrapper.ownerDocument, "mousemove", a),
                                    T(o.scroller, "dragstart", u),
                                    T(o.scroller, "drop", s),
                                l || (D(e),
                                i.addNew || Ei(t.doc, r, null, null, i.extend),
                                    x && !V || w && 9 == v ? setTimeout(function() {
                        ...
                        : function(d, e, f, p) {
                            ...
                            "rectangle" == p.unit ? (p.addNew || (m = new G(f,f)),
                                f = cr(d, e, !0, !0),
                                v = -1) : (e = il(d, f, p.unit),
                                m = p.extend ? Pi(m, e.anchor, e.head, p.extend) : e);
                            p.addNew ? -1 == v ? (v = t.length,
                                U(g, di(d, t.concat([m]), v), {
                                    scroll: !1,
                                    origin: "*mouse"
                                })) : 1 < t.length && t[v].empty() && "char" == p.unit && !p.extend ? (U(g, di(d, t.slice(0, v).concat(t.slice(v + 1)), 0), {
                                scroll: !1,
                                origin: "*mouse"
                            }),
                                y = g.sel) : Ri(g, v, m, fe) : (U(g, new B([m],v = 0), fe),
                                y = g.sel);
                            var b = f;
                            function s(e) {
                                if (0 != P(b, e))
                                    ...
                                    "rectangle" == p.unit) {
                                        for (var t = [], n = d.options.tabSize, r = S(W(g, f.line).text, f.ch, n), i = S(W(g, e.line).text, e.ch, n), o = Math.min(r, i), l = Math.max(r, i), s = Math.min(f.line, e.line), a = Math.min(d.lastLine(), Math.max(f.line, e.line)); s <= a; s++) {
                                            var u = W(g, s).text
                                                , c = ge(u, o, n);
                                            o == l ? t.push(new G(F(s, c),F(s, c))) : u.length > c && t.push(new G(F(s, c),F(s, ge(u, l, n))))
                                        }
                                        t.length || t.push(new G(f,f)),
                                            U(g, di(d, y.ranges.slice(0, v).concat(t), v), {
                                                origin: "*mouse",
                                                scroll: !1
                                            }),
                                            d.scrollIntoView(e)
                                    } else {
                                        var h, r = m, i = il(d, e, p.unit), e = r.anchor, e = 0 < P(i.anchor, e) ? (h = i.head,
                                            wt(r.from(), i.anchor)) : (h = i.anchor,
                                            bt(r.to(), i.head)), r = y.ranges.slice(0);
                                        r[v] = function(e, t) {
                                            var n = t.anchor
                                                , r = t.head
                                                , i = W(e.doc, n.line);
                                            ...
                                            if (0 == s || s == i.length)
                                                return t;
                                            l = r.line != n.line ? 0 < (r.line - n.line) * ("ltr" == e.doc.direction ? 1 : -1) : (e = Ae(i, r.ch, r.sticky),
                            ...
                            var r = z(d, function(e) {
                                (0 !== e.buttons && $e(e) ? function e(t) {
                                        var n, r, i = ++u, o = cr(d, t, !0, "rectangle" == p.unit);
                                        o && (0 != P(o, b) ? (d.curOp.focus = N(),
                                            s(o),
                                            n = Mr(l, g),
                                        (o.line >= n.to || o.line < n.from) && setTimeout(z(d, function() {
                                            u == i && e(t)
                                        }), 150)) : (r = t.clientY < a.top ? -20 : t.clientY > a.bottom ? 20 : 0) && setTimeout(z(d, function() {
                ...
                )(i, s, o, a)) : Ye(e) == h.scroller && D(e) : 2 == n ? (t && Ei(c.doc, t),
                setTimeout(function() {
                    return h.input.focus()
                }, 20)) : 3 == n && (Z ? c.display.input.onContextMenu(e) : Cr(c)))))
    }
    function il(e, t, n) {
        if ("char" == n)
            return new G(t,t);
    ...
    function sl(e, t) {
        var n, r;
        kn(e.display, t) || (r = t,
        Ue(n = e, "gutterContextMenu") && ol(n, r, "gutterContextMenu", !1)) || A(e, t, "contextmenu") || Z || e.display.input.onContextMenu(t)
    }
    function al(e) {
        e.display.wrapper.className = e.display.wrapper.className.replace(/\s*cm-s-\S+/g, "") + e.options.theme.replace(/(^|\s)\s*/g, " cm-s-"),
            Un(e)
    }
    el.prototype.compare = function(e, t, n) {
    ...
    var ul = {
        ...
        , hl = {};
    function dl(e, t, n) {
        !t != !(n && n != ul) && (n = e.display.dragFunctions,
    ...
    function fl(e) {
        e.options.lineWrapping ? (re(e.display.wrapper, "CodeMirror-wrap"),
            e.display.sizer.style.minWidth = "",
            e.display.sizerWidth = null) : (J(e.display.wrapper, "CodeMirror-wrap"),
            nn(e)),
            ur(e),
            I(e),
            Un(e),
    ...
    function p(e, t) {
        ...
        if (!(this instanceof p))
            return new p(e,t);
        this.options = t = t ? ae(t) : {},
            ae(cl, t, !1);
        var r, i = t.value, o = ("string" == typeof i ? i = new f(i,t.mode,null,t.lineSeparator,t.direction) : t.mode && (i.modeOption = t.mode),
            this.doc = i,
            new p.inputStyles[t.inputStyle](this)), e = this.display = new li(e,i,o,t), l = (al(e.wrapper.CodeMirror = this),
        ...
        w && v < 11 && setTimeout(function() {
            ...
            this), s = l.display;
        k(s.scroller, "mousedown", z(l, rl)),
            k(s.scroller, "dblclick", w && v < 11 ? z(l, function(e) {
                    var t;
                    A(l, e) || (!(t = cr(l, e)) || ll(l, e) || kn(l.display, e) || (D(e),
                        e = l.findWordAt(t),
                        Ei(l.doc, e.anchor, e.head)))
                }) : function(e) {
                    return A(l, e) || D(e)
                }
            ),
            ...
            k(s.input.getField(), "contextmenu", function(e) {
                s.scroller.contains(e.target) || sl(l, e)
            });
        var a, u = {
            end: 0
        };
        ...
        k(s.scroller, "touchstart", function(e) {
            ...
            k(s.scroller, "touchend", function(e) {
                ...
                n && !kn(s, e) && null != n.left && !n.moved && new Date - n.start < 300 && (t = l.coordsChar(s.activeTouch, "page"),
            ...
            k(s.scroller, "scroll", function() {
                s.scroller.clientHeight && (Fr(l, s.scroller.scrollTop),
                    Er(l, s.scroller.scrollLeft, !0),
                    O(l, "scroll", l))
            }),
            ...
            s.dragFunctions = {
                ...
                over: function(e) {
                    var t, n;
                    A(l, e) || ((n = cr(t = l, n = e)) && (yr(t, n, n = document.createDocumentFragment()),
                ...
                start: function(e) {
                    ...
                    t = l,
                        e = e,
                        w && (!t.state.draggingText || +new Date - yo < 100) ? Xe(e) : A(t, e) || kn(t.display, e) || (e.dataTransfer.setData("Text", t.getSelection()),
                            e.dataTransfer.effectAllowed = "copyMove",
                        e.dataTransfer.setDragImage && !V && ((n = M("img", null, null, "position: fixed; left: 0; top: 0;")).src = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",
                        m && (n.width = n.height = 1,
                            t.display.wrapper.appendChild(n),
                            n._top = n.offsetTop),
                            e.dataTransfer.setDragImage(n, 0, 0),
                        m && n.parentNode.removeChild(n)))
                },
                drop: z(l, bo),
                leave: function(e) {
                    A(l, e) || wo(l)
        ...
        for (r in k(o, "keyup", function(e) {
            ...
            Si(this, i),
            t.autofocus && !$ || this.hasFocus() ? setTimeout(function() {
                n.hasFocus() && !n.state.focused && Sr(n)
            }, 20) : Lr(this),
            hl)
            hl.hasOwnProperty(r) && hl[r](this, t[r], ul);
        ni(this),
    ...
    var pl = [];
    function gl(e, t, n, r) {
        var i, o = e.doc, l = ("smart" == (n = null == n ? "add" : n) && (o.mode.indent ? i = Mt(e, t).state : n = "prev"),
            e.options.tabSize), s = W(o, t), a = S(s.text, null, l), u = (s.stateAfter && (s.stateAfter = null),
            s.text.match(/^\s*/)[0]);
        if (r || /\S/.test(s.text)) {
            if ("smart" == n && ((c = o.mode.indent(i, s.text.slice(u.length), s.text)) == he || 150 < c)) {
                if (!r)
                    return;
                n = "prev"
            }
        ...
        if (d < c && (h += ve(c - d)),
        h != u)
            return to(o, h, F(t, 0), F(t, u.length), "+input"),
                !(s.stateAfter = null);
    ...
    function yl(e, t, n, r, i) {
        ...
        if (s && 1 < r.ranges.length)
            if (ml && ml.text.join("\n") == t) {
                if (r.ranges.length % ml.text.length == 0)
                    for (var u = [], c = 0; c < ml.text.length; c++)
                        u.push(o.splitLines(ml.text[c]))
            } else
                a.length == r.ranges.length && e.options.pasteLinesPerSelection && (u = ye(a, function(e) {
                    return [e]
                }));
        for (var h = e.curOp.updateInput, d = r.ranges.length - 1; 0 <= d; d--) {
            var f = r.ranges[d]
                , p = f.from()
                , g = f.to()
                , f = (f.empty() && (n && 0 < n ? p = F(p.line, p.ch - n) : e.state.overwrite && !s ? g = F(g.line, Math.min(W(o, g.line).text.length, g.ch + R(a).length)) : s && ml && ml.lineWise && ml.text.join("\n") == a.join("\n") && (p = g = F(p.line, 0))),
                {
                    from: p,
                    to: g,
    ...
    function bl(e, t) {
        ...
        t.isReadOnly() || t.options.disableInput || h(t, function() {
            return yl(t, n, 0, null, "paste")
        }),
            1)
    }
    function wl(e, t) {
                    ...
                    if (o.electricChars) {
                        for (var s = 0; s < o.electricChars.length; s++)
                            if (-1 < t.indexOf(o.electricChars.charAt(s))) {
                                l = gl(e, i.head.line, "smart");
                                break
                            }
                    } else
                        o.electricInput && o.electricInput.test(W(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = gl(e, i.head.line, "smart"));
    ...
    function Sl() {
        ...
        X && (e.style.border = "1px solid black"),
            Cl(e),
            t
    }
    function Ll(n, r, i, o, l) {
        var e = r
            , t = i
            , s = W(n, r.line)
        ...
        function u(e) {
            ...
            if (null == (t = "codepoint" == o ? (t = s.text.charCodeAt(r.ch + (0 < i ? 0 : -1)),
                isNaN(t) ? null : (t = 0 < i ? 55296 <= t && t < 56320 : 56320 <= t && t < 57343,
                    new F(r.line,Math.max(0, Math.min(s.text.length, r.ch + i * (t ? 2 : 1))),-i))) : l ? Go(n.cm, s, r, i) : zo(s, r, i))) {
                if (e || (e = r.line + a) < n.first || e >= n.first + n.size || (r = new F(e,r.ch,r.sticky),
                    !(s = W(n, e))))
                    return;
                r = Bo(l, n.cm, s, r.line, a)
            } else
                r = t;
            return 1
        }
    ...
    function kl(e, t, n, r) {
        ...
        for ("page" == r ? (i = Math.min(e.display.wrapper.clientHeight, window.innerHeight || document.documentElement.clientHeight),
            i = Math.max(i - .5 * ir(e.display), 3),
            o = (0 < n ? t.bottom : t.top) + n * i) : "line" == r && (o = 0 < n ? t.bottom + 3 : t.top - 3); (l = Qn(e, a, o)).outside; ) {
    ...
    function Nl(e, t, n) {
        ...
        if (t == e.display.lineDiv) {
            if (!(r = e.display.lineDiv.childNodes[n]))
                return Ml(e.clipPos(F(e.display.viewTo - 1)), !0);
            t = null,
                n = 0
        } else
        ...
        for (var i = 0; i < e.display.view.length; i++) {
            ...
            if (o.node == r) {
                var u = o
                    ...
                    , a = !1;
                if (!o || !ne(s, o))
                    return Ml(F(H(u.line), 0), !0);
                if (o == s)
                    if (a = !0,
                        o = s.childNodes[l],
                        l = 0,
                        !o)
                        return Ml(F(H(c = u.rest ? R(u.rest) : u.line), c.text.length), a);
    ...
    r.prototype.init = function(e) {
        ...
        s.contentEditable = !0,
            Cl(s, l.options.spellcheck, l.options.autocorrect, l.options.autocapitalize),
            k(s, "paste", function(e) {
                !a(e) || A(l, e) || bl(e, l) || v <= 11 && setTimeout(z(l, function() {
        ...
        r.prototype.showPrimarySelection = function() {
            ...
            if (t.display.viewTo == t.display.viewFrom || r.line >= t.display.viewTo || n.line < t.display.viewFrom)
                ...
                var i = Nl(t, e.anchorNode, e.anchorOffset)
                    , o = Nl(t, e.focusNode, e.focusOffset);
                if (!i || i.bad || !o || o.bad || 0 != P(wt(i, o), r) || 0 != P(bt(i, o), n)) {
                    var i = t.display.view
                        , o = r.line >= t.display.viewFrom && Tl(t, r) || {
                        node: i[0].measure.map[2],
                        offset: 0
                    }
                        , r = n.line < t.display.viewTo && Tl(t, n);
                    if (r || (r = {
        ...
        r.prototype.selectionInEditor = function() {
            ...
            return ne(this.div, e)
        }
        ,
        r.prototype.focus = function() {
            "nocursor" != this.cm.options.readOnly && (this.selectionInEditor() && N() == this.div || this.showSelection(this.prepareSelection(), !0),
                this.div.focus())
        }
        ,
        ...
        r.prototype.pollSelection = function() {
            if (null == this.readDOMTimeout && !this.gracePeriod && this.selectionChanged()) {
                ...
                if (Y && c && this.cm.display.gutterSpecs.length && function(e) {
                ...
                this.composing || (this.rememberSelection(),
                    e = Nl(r, n.anchorNode, n.anchorOffset),
                    t = Nl(r, n.focusNode, n.focusOffset),
                e && t && h(r, function() {
                    U(r.doc, fi(e, t), de),
        ...
        r.prototype.pollContent = function() {
            ...
            i.line < n.viewFrom || r.line > n.viewTo - 1)
                return !1;
            var o, l = i.line == n.viewFrom || 0 == (l = hr(t, i.line)) ? (e = H(n.view[0].line),
                n.view[0].node) : (e = H(n.view[l].line),
                n.view[l - 1].node.nextSibling), r = hr(t, r.line), n = r == n.view.length - 1 ? (o = n.viewTo - 1,
                ...
                for (; !function e(t) {
                    if (1 == t.nodeType) {
                        ...
                        if (n)
                            ...
                            ))).length && (n = n[0].find(0)) && d(ht(o.doc, n.from, n.to).join(u));
                    ...
                    e = e.nextSibling,
                        c = !1;
                return n
            }(t, l, n, e, o)), a = ht(t.doc, F(e, 0), F(o, W(t.doc, o).text.length)); 1 < s.length && 1 < a.length; )
                if (R(s) == R(a))
                    s.pop(),
                        a.pop(),
                        o--;
            ...
            for (var u = 0, c = 0, h = s[0], d = a[0], f = Math.min(h.length, d.length); u < f && h.charCodeAt(u) == d.charCodeAt(u); )
                ++u;
            for (var p = R(s), g = R(a), m = Math.min(p.length - (1 == s.length ? u : 0), g.length - (1 == a.length ? u : 0)); c < m && p.charCodeAt(p.length - c - 1) == g.charCodeAt(g.length - c - 1); )
                ++c;
            ...
            r = F(e, u),
                l = F(o, a.length ? R(a).length - c : 0);
            return 1 < s.length || s[0] || P(r, l) ? (to(t.doc, s, r, l, "+input"),
                !0) : void 0
        }
        ,
        ...
        r.prototype.onKeyPress = function(e) {
            ...
            this.cm.isReadOnly() || z(this.cm, yl)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0))
        }
        ,
    ...
    i.prototype.init = function(n) {
            ...
            if (!A(i, e)) {
                if (i.somethingSelected())
                    ...
                    vl({
                        ...
                        "cut" == e.type ? i.setSelections(t.ranges, null, de) : (r.prevInput = "",
                            o.value = t.text.join("\n"),
                            le(o))
                }
        ...
        X && (o.style.width = "0px"),
            ...
            k(o, "paste", function(e) {
                A(i, e) || bl(e, i) || (i.state.pasteIncoming = +new Date,
                    r.fastPoll())
            }),
            k(o, "cut", t),
            k(o, "copy", t),
        ...
        i.prototype.prepareSelection = function() {
            var e, t = this.cm, n = t.display, r = t.doc, i = vr(t);
            return t.options.moveInputWithCursor && (t = _n(t, r.sel.primary().head, "div"),
        ...
        i.prototype.focus = function() {
            if ("nocursor" != this.cm.options.readOnly && (!$ || N() != this.textarea))
                try {
                    this.textarea.focus()
                } catch (e) {}
        }
        ...
        i.prototype.poll = function() {
            var e = this
                ...
                , n = this.textarea
                , r = this.prevInput;
            if (this.contextMenuPending || !t.state.focused || Je(n) && !r && !this.composing || t.isReadOnly() || t.options.disableInput || t.state.keySeq)
                return !1;
            var i = n.value;
            ...
            for (var l = 0, s = Math.min(r.length, i.length); l < s && r.charCodeAt(l) == i.charCodeAt(l); )
                ++l;
            return h(t, function() {
                yl(t, i.slice(l), r.length - l, null, e.composing ? "*compose" : null),
        ...
        i.prototype.onContextMenu = function(e) {
            ...
            function d() {
                ...
                null != a.selectionStart && ((!w || v < 9) && h(),
                    e = 0,
                    t = function() {
                        s.selForContextMenu == l.doc.sel && 0 == a.selectionStart && 0 < a.selectionEnd && "​" == o.prevInput ? z(l, $i)(l) : e++ < 10 ? s.detectingSelectAll = setTimeout(t, 500) : (s.selForContextMenu = null,
                            s.input.reset())
                    }
                    ,
                    s.detectingSelectAll = setTimeout(t, 200)))
            }
            u && !m && (l.options.resetSelectionOnContextMenu && -1 == l.doc.sel.contains(u) && z(l, U)(l.doc, fi(u), de),
                n = a.style.cssText,
        ...
        o("lineSeparator", null, function(e, r) {
            if (e.doc.lineSep = r) {
                ...
                for (var t = i.length - 1; 0 <= t; t--)
                    to(e.doc, r, i[t], F(i[t].line, i[t].ch + r.length))
            }
        }),
        ...
        o("specialCharPlaceholder", un, function(e) {
            return e.refresh()
        }, !0),
        o("electricChars", !0),
        o("inputStyle", $ ? "contenteditable" : "textarea", function() {
        ...
        o("lineWrapping", !1, fl, !0),
        o("gutters", [], function(e, t) {
            e.display.gutterSpecs = ri(t, e.options.lineNumbers),
                oi(e)
        }, !0),
        o("fixedGutter", !0, function(e, t) {
            e.display.gutters.style.left = t ? sr(e.display) + "px" : "0",
                e.refresh()
        }, !0),
        ...
        o("lineNumbers", !1, function(e, t) {
            e.display.gutterSpecs = ri(e.options.gutters, t),
                oi(e)
        }, !0),
        o("firstLineNumber", 1, oi, !0),
        o("lineNumberFormatter", function(e) {
            return e
        }, oi, !0),
        o("showCursorWhenSelecting", !1, mr, !0),
        ...
        o("cursorHeight", 1, mr, !0),
        o("singleCursorHeightPerLine", !0, mr, !0),
        o("workTime", 100),
        o("workDelay", 100),
        o("flattenSpans", !0, bi, !0),
        o("addModeClass", !1, bi, !0),
        o("pollInterval", 100),
        ...
        Dl.prototype = {
            ...
            setOption: function(e, t) {
                var n = this.options
                    , r = n[e];
                n[e] == t && "mode" != e || (n[e] = t,
                Wl.hasOwnProperty(e) && z(this, Wl[e])(this, t, r),
            ...
            addOverlay: t(function(e, t) {
                var n = e.token ? e : Dl.getMode(this.options, e);
                if (n.startState)
            ...
            indentLine: t(function(e, t, n) {
                ...
                gt(this.doc, e) && gl(this, e, t, n)
            }),
            indentSelection: t(function(e) {
                for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
                    var i = t[r];
                    if (i.empty())
                        i.head.line > n && (gl(this, i.head.line, e, !0),
                            n = i.head.line,
                        ...
                        0 == o.ch && t.length == i.length && 0 < i[r].from().ch && Ri(this.doc, r, new G(o,i[r].to()), de)
                    }
                }
            }),
            ...
            getLineTokens: function(e, t) {
                return Wt(this, F(e), t, !0)
            },
            getTokenTypeAt: function(e) {
                e = E(this.doc, e);
                var t, n = Tt(this, W(this.doc, e.line)), r = 0, i = (n.length - 1) / 2, o = e.ch;
                if (0 == o)
                    t = n[2];
                else
                    for (; ; ) {
            ...
            getModeAt: function(e) {
                var t = this.doc.mode;
                return t.innerMode ? Dl.innerMode(t, this.getTokenAt(e).state).mode : t
            },
            ...
            getStateAfter: function(e, t) {
                var n = this.doc;
                return Mt(this, (e = xt(n, null == e ? n.first + n.size - 1 : e)) + 1, t).state
            },
            cursorCoords: function(e, t) {
                var n = this.doc.sel.primary()
                    , e = null == e ? n.head : "object" == typeof e ? E(this.doc, e) : e ? n.from() : n.to();
                return _n(this, e, t || "page")
            },
            charCoords: function(e, t) {
                return $n(this, E(this.doc, e), t || "page")
            },
            coordsChar: function(e, t) {
                return Qn(this, (e = Yn(this, e, t || "page")).left, e.top)
            },
            lineAtHeight: function(e, t) {
                return e = Yn(this, {
                    ...
                    pt(this.doc, e + this.display.viewOffset)
            },
            heightAtLine: function(e, t, n) {
                ...
                return Xn(this, i, {
                    top: 0,
                    left: 0
                }, t || "page", n || r).top + (r ? this.doc.height - en(i) : 0)
            },
            ...
            addWidget: function(e, t, n, r, i) {
                var o, l, s = this.display, a = (e = _n(this, E(this.doc, e))).bottom, u = e.left;
                ...
                null != (l = Nr(r, l)).scrollTop && Fr(r, l.scrollTop),
                null != l.scrollLeft && Er(r, l.scrollLeft))
            },
            triggerOnKeyDown: t(Zo),
            triggerOnKeyPress: t(Jo),
            triggerOnKeyUp: Qo,
            triggerOnMouseDown: t(rl),
            execCommand: function(e) {
                if (Uo.hasOwnProperty(e))
                    return Uo[e].call(null, this)
            },
            ...
            findPosH: function(e, t, n, r) {
                for (var i = 1, o = (t < 0 && (i = -1,
                    t = -t),
                    E(this.doc, e)), l = 0; l < t && !(o = Ll(this.doc, o, i, n, r)).hitSide; ++l)
                    ;
                return o
            },
            moveH: t(function(t, n) {
                ...
                this.extendSelectionsBy(function(e) {
                    return r.display.shift || r.doc.extend || e.empty() ? Ll(r.doc, e.head, t, n, r.options.rtlMoveVisually) : t < 0 ? e.from() : e.to()
                }, pe)
            }),
            deleteH: t(function(n, r) {
                var e = this.doc.sel
                    , i = this.doc;
                e.somethingSelected() ? i.replaceSelection("", null, "+delete") : Io(this, function(e) {
                    var t = Ll(i, e.head, n, r, !1);
                    return n < 0 ? {
                        from: t,
                        to: e.head
                    } : {
            ...
            moveV: t(function(r, i) {
                ...
                if (l.extendSelectionsBy(function(e) {
                    ...
                    var t = _n(o, e.head, "div")
                        , n = (null != e.goalColumn && (t.left = e.goalColumn),
                        s.push(t.left),
                        kl(o, t, r, i));
                    return "page" == i && e == l.sel.primary() && Or(o, $n(o, n, "div").top - t.top),
                        n
                }, pe),
                    s.length)
            ...
            findWordAt: function(e) {
                ...
                if (t) {
                    for (var i = this.getHelper(e, "wordChars"), o = ("before" != e.sticky && r != t.length || !n ? ++r : --n,
                        t.charAt(n)), l = Se(o, i) ? function(e) {
                            return Se(e, i)
                        }
                        : /\s/.test(o) ? function(e) {
                                return /\s/.test(e)
            ...
            toggleOverwrite: function(e) {
                null != e && e == this.state.overwrite || (((this.state.overwrite = !this.state.overwrite) ? re : J)(this.display.cursorDiv, "CodeMirror-overwrite"),
            ...
            scrollIntoView: t(function(e, t) {
                ...
                e.to || (e.to = e.from),
                    ...
                    null != e.from.line ? (t = e,
                        Wr(n = this),
                        n.curOp.scrollToPos = t) : Hr(this, e.from, e.to, e.margin)
            }),
            ...
            refresh: t(function() {
                ...
                I(this),
                    ...
                    Jr(this.display),
                (null == e || .5 < Math.abs(e - ir(this.display)) || this.options.lineWrapping) && ur(this),
                    O(this, "refresh", this)
            }),
        ...
        Ve(Dl),
        Dl.registerHelper = function(e, t, n) {
            Hl.hasOwnProperty(e) || (Hl[e] = Dl[e] = {
                _global: []
            }),
                Hl[e][t] = n
        }
        ,
        Dl.registerGlobalHelper = function(e, t, n, r) {
            Dl.registerHelper(e, t, r),
                Hl[e]._global.push({
                    pred: n,
                    val: r
                })
    ...
    ;
    var Fl, Pl = "iter insert remove copy getEditor constructor".split(" ");
    for (Fl in f.prototype)
        f.prototype.hasOwnProperty(Fl) && L(Pl, Fl) < 0 && (p.prototype[Fl] = function(e) {
            return function() {
    ...
    return Ve(f),
        ...
        e.isModifierKey = Ho,
        e.lookupKey = Wo,
        e.normalizeKeyMap = Do,
        e.StringStream = g,
        e.SharedTextMarker = po,
        e.TextMarker = co,
        e.LineWidget = ao,
...
(function (mod) {
    ...
    function setPlaceholder(cm) {
        ...
        elt.style.cssText = "height: 0; overflow: visible;color: #909090;";
